...
public class GenerateHole
{
    ...
    private (List<Face>, List<Vector3>) CreateSubFaces(List<Vector3> intersectionPoints, List<int> mainFaceIndices, List<int> subFaceIndices, List<Vector3> meshVertices)
    {
        ...
        // Seperate Subface
        int subface_index_W = modifiedVertices.Count; modifiedVertices.Add(meshVertices[WIndex]);
        int subface_index_X = modifiedVertices.Count; modifiedVertices.Add(meshVertices[XIndex]);
        int subface_index_Y = modifiedVertices.Count; modifiedVertices.Add(meshVertices[YIndex]);
        int subface_index_Z = modifiedVertices.Count; modifiedVertices.Add(meshVertices[ZIndex]);
